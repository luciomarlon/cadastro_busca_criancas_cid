...
public class FrmAcompanhamentos extends javax.swing.JFrame {

    /**
     * Creates new form Frm_Acompanhamentos
     */
    public FrmAcompanhamentos() {
        initComponents();
        restauraComboAluno();
    ...
    private void initComponents() {
        ...
        jLabel9.setText("ACOMPANHAMENTOS");
        ...
        btnAcompanhamento.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        btnAcompanhamento.setText("Cadastrar");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnAcompanhamento, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
...
//        String acompanhamento, instrumento, natureza, observacoes;
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        FrmAtualizarAcompanhamentos acompanhamentos = new FrmAtualizarAcompanhamentos();
        acompanhamentos.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAcompanhamentos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAcompanhamentos().setVisible(true);
            }
        });
    }
