...
public class FrmPesquisarEscolas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnAlterar, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 660, 200, 60));
...
//       FrmAtualizarAlunos cadastroAlunos = new FrmAtualizarAlunos();
   ...
   private void ListarEscolas()
    {
        ...
        ResultSet retornaescolas = listaescolas.Escolas();
