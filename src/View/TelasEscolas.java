 ...
 * @author LucioMarlon
 */
public class TelasEscolas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCadastrar.setText("Cadastrar Escola");
        ...
        btnAtualizarAlunos.setText("Buscar/Atualizar Escola");
        ...
        btnBuscar2.setText("Buscar Professor por escola");
        ...
        btnBuscar4.setText("Buscar alunos por escola");
    ...
    private void btnAtualizarAlunosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarAlunosActionPerformed
        FrmPesquisarEscolas buscarescolas = new FrmPesquisarEscolas();
        buscarescolas.setLocationRelativeTo(null);
        buscarescolas.setVisible(true);
    ...
    private void btnHomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHomeActionPerformed
        TelasEscolas telaescolas = new TelasEscolas();
        telaescolas.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//        telaescolas.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelasEscolas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelasEscolas().setVisible(true);
            }
        });
    }
